...
Neural network model discussed in ["A graph-based machine learning framework to assign empirical interaction parameters for novel molecules"](https://onlinelibrary.wiley.com/doi/10.1002/jcc.70508) (doi: 10.1002/jcc.70508)
